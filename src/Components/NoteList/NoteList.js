...
function NoteList({ text, index, complete, removeNote, id, toggleComplete }) {

  return (
    <div className="notelist">
      <div className="notelist__wrapper">
        <ul className="notelist__content">
          <li
            onClick={() => toggleComplete(index)}
            className={complete ? "notelist__content-text notelist__complete" : "notelist__content-text"}>
            {text}
          </li>
        </ul>
        <button className="notelist__trash" onClick={() => removeNote(id)}>
          <svg
            width="22"
            height="26"
            viewBox="0 0 20 21"
